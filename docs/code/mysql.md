...
Only most used but hard to remember commands will be documented here

<table-code>

<table-row-code title="Insert Insert"  
code="
 INSERT INTO users 
...
<table-row-code title="Insert Multiple Rows"  
code="
INSERT INTO users 
(first_name, last_name, email, password, location, dept,  is_admin, register_date)
...
<table-row-code title="Select Where Clause"  
code="
...
<table-row-code title="Update"  
code="
UPDATE users SET email = 'freddy@gmail.com' WHERE id = 2;
" />

<table-row-code title="Add New Column"  
code="
ALTER TABLE users ADD age VARCHAR(3);
" />

<table-row-code title="Order By (Sort)"  
code="
SELECT * FROM users ORDER BY last_name ASC;
SELECT * FROM users ORDER BY last_name DESC;
" />

<table-row-code title="Modify"  
code="
...
<table-row-code title="Like (Searching)"  
code="
...
<table-row-code title="Aggregate Functions"  
code="
